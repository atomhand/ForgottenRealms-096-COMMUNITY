...
#newweapon 2014
#copyweapon 459 --thrown sutra
#name "Light Ray"
#ammo 1005 -- fatigue cost
#end
...
In the view of some scholars, lantern archons were not true archons but only 'proto-archons', from which all other archons were ultimately derived. Only a handful of nations may call on archons due to their associations with the Gods of the Triad and their traditionnaly aggressive stance against evil."
#clearspec
#fireres 15
#poisonres 15
#miscshape 
...
#spr1 "ForgottenRealms/liongolden.tga"
#spr2 "ForgottenRealms/liongolden2.tga"
#name "Celestial Lion"
#descr "Celestials were good outsiders from one of the Celestial Planes and were the counterpart and antithesis of fiends. They performed many roles across the multiverse. They were divine heralds who brought the messages of the Upper-planar gods to those who needed to hear them and were agents of good who sometimes acted outside the divine mandate. They were the punishers of the wicked and ministers to the needy, protectors of the innocent and liberators of the enslaved. They were both wanderers who roamed the planes to find the good in all things and guides who led champions in their quests against evil. They were the embodiments of the multiverse's purity and the pinnacles of benevolence and valor. They were all these things. As a group, they were the champions of the betterment of the cosmos and encouraged the spread of harmony and freedom, both for individuals and for societies. They always acted for the utmost benefit of others, to inspire charity, mercy, and helpfulness in turn, and bent their tremendous cosmic influence to the support of good and the thwarting of evil."
#hp 28
#size 4
#prot 10
#mor 16
