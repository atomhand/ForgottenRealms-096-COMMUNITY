...
#name "Temple to the Mother of Magic"
...
#name "Shrine of the Lord of Murder"
...
#name "Shrine of the Lord of the Dead"
...
#name "Temple to the Moonmaiden"

#descr "Selûne, also known as Our Lady of Silver, the Moonmaiden, and the Night White Lady, was the goddess of the moon in the Faerûnian pantheon. Her portfolio included  moonlight, and stars, beauty and purity, love and marriage, navigation and navigators, tracking, wanderers, seekers, diviners and dreams."
...
#name "Temple to the Lady of the Harvest"
...
#name "Temple of The Even-Handed"
...
#name "The Binder of What is Known"
...
-- 5028 -- Great Bara of Ubtao -- Pretender 1
#newmonster 5028
#copystats 732
#clearspec
#clearmagic
...
#clearweapons
#cleararmor
#name "Asmodeus, Master of the 9 Hells"
...
-- 5040 -- Elminster
#newmonster 5040
#copystats 92 -- Was 244 Arch Mage Pretender
#clearspec
#spr1 "ForgottenRealms/elminster1.tga"
#spr2 "ForgottenRealms/elminster2.tga"
#name "The Sage of Shadowdale"
#descr "Born in 212 DR, Elminster Aumar was one of the most famous and powerful wizards in all of Faerûn. The 'Sage of Shadowdale' was known from the Sword Coast to the far-off jungles of Chult to the unapproachable east all the way to Thay. Over the course of his centuries-long life Elminster had saved the people of Faerûn from destruction or subjugation on dozens of occasions and earned himself a well-dserved, legendary reputation.

Before he devoted his life to the Mystran faith or even began his wizardly studies, the young Elminster possessed the innate ability to heal himself and detect magical auras at will. He was also blessed with an eidetic memory, that allowed him to recall information from years past in quite an impressive manner and this exceptional intelligence was additionally bolstered over the centuries by multiple castings of the wish spell. 

Elminster had knowledge of every spell that was commonly available to most adventuring spellcasters in the Realms. Though he did not use every spell he knew. Having planewalked far and wide and having seen the price of summoning and binding powerful beings to Faerûn, he generally preferred to avoid magic from the school of conjuration and anything associated with creatures from the lower planes. 

Among his allies were countless heroes of the realms, both alive and dead. Legends like Mordenkainen, Khelben Aruson of Waterdeep, and Mystras own daughters - the Seven Sisters, 3 of whom he raised as children and one of whom, the Simbul, he counts as the love of his long life. Adored by his friends and despised by all those whose dark plans he has thwarted, Elminster humbly accepts his role as the shaper of the realms. 

As one of Mystra's Chosen, Elminster will remain immortal, so long as he is within friendly dominion. 

'Arch-lich, I mock everyone. Myself, most of all. It's how I guard my heart against the flailing lashings of life.' - Elminster to Larloch, Shadow-King of Netheril"
...
#drainimmune
#moremagic -1
#itemslots 3932190 -- 4 hands, 4 misc
#end
...
-- 7171 -- Lolth -- PRETENDER
#newmonster 7171 -- Lolth
#copystats 3651 -- God Spider
#spr1 "ForgottenRealms/llolth.tga"
#spr2 "ForgottenRealms/llolth2.tga"
#name "Queen of the Demonweb Pits"
#descr "Known as the Queen of Spiders as well as the Queen of the Demonweb Pits, Lolth was the most influential goddess of the drow, within the pantheon of the Dark Seldarine.
...
#copystats 1520 
#clearspec
#spr1 "ForgottenRealms/pisaethces.tga"
#spr2 "ForgottenRealms/pisaethces2.tga"
#name "Pisaethces, The Blood Queen"
#fixedname "Pisaethces"
#descr "The first aboleths came into being from Pisaethces' blood, the by-product of an accidental interaction between her body and the material world. Known as The Blood Queen, Pisaethces was an Elder Evil. She was depicted as a vast, tentacle-less aboleth with mucus the color of blood. Her interests lay beyond the known dimensions, and she had no interest in her creations as either companions or scientific curiosities. The aboleths believed that Pisaethces traveled the currents of probability across infinite realities, spreading her seed as less than an afterthought as she moved between the worlds.
...
Insane cultists were known to try and call her back to the physical world and this small clergy of wizard-priests followed a ruthless creed of domination and suppression. These cultists believed in her ability to grant them power, and a few did in fact manifest divine magic - whether from Pisaethces herself or conjured from their own madness."
#gcost 10000
#hp 385
#size 10
#prot 15
...
#clearspec
#clearmagic
#spr1 "ForgottenRealms/shapeofwater.tga"
#spr2 "ForgottenRealms/shapeofwater2.tga"
#name "The Shape of Water"
#descr "A city known as The Shape of Water formed around the fallen obelisk of Xxiphu sometime in the deep prehistory of Faerun. it and came to be ruled by a race of Aboleths wholly unrelated to those slumbering within Xipphu. As the obelisk and its aboleth inhabitants slumbered, it drew aberrations to Faerun from across the planes. 

Over tens if not hundreds of thousands of years, the city was built and rebuilt many times, leaving a sprawling maze of ruins and impossible alien architecture. While the obelisk that lies in the city's heart may one day rise, the Shape of Water will still remain, its living walls humming the tune of the Symphony of Madness and defending itself psionically from any enemies who dare to enter." 
#fixedname "The Shape of Water"
#gcost 10000
#miscshape
#startdom 4
#size 10
...
-- 7492 -- Corellon Shrine 4 
#newmonster 7492
#copystats 158
#clearspec
#clearmagic
#spr1 "ForgottenRealms/templecorrellon.tga"
#spr2 "ForgottenRealms/templecorrellon2.tga"
#name "First of the Seldarine"
#descr "Corellon Larethian, whose titles included Creator of the Elves and the Protector, was the patron god of all elvenkind. He governed those things which are held in the highest esteem among the Tel'Quessir - magic, music, arts, crafts, poetry, and warfare. He approved of those who killed orcs and the followers of Lolth, blessed those who aided others, and was angered at any who defiled the dead or fled from their foes. Elves believed that they were destined for reincarnation through Corellon's divine essence, living again and again until they reached their final goal of self-perfection. Corellon, alongside Sehanine Moonbow, was the souls' guide towards that perfected state. 

Corellon watched over the elven race as a guardian. It has, however, been nearly 1,000 years since Corellon engaged in world-shaping events on Faerun. Some time before 714 DR, before the fall of Cormanthor, elves wearied of competing with humans over land and wanted land for themselves free of encroaching human expansion. Under Corellon, the Seldarine started the Retreat, a mystical compulsion felt by elves to abandon their lands for the hidden island of Evermeet. Most of Corellon's followers answered the call and left Faerûn. 

Former husband to Araushnee (later known as Lolth) and father of their two children, Vhaeraun and Eilistraee, Corellon has a colorful past. His battles against the orc god, Gruumsh, were legendary. His wife's betrayal nearly gave Gruumsh the advantage he needed to kill the elven god. Sehanine Moonbow saved his life, and as the elven creation myth tells, Corellons blood mixed with Sehanine's tears and the elven race was spawned. Upon reaching supposed safety, the two were then ambushed by Malar and barely survived. Araushnee became known as the Spider Queen, and the rest is a long but worthwhile read.

By choosing this pretender, you will gain access to expanded magic, production, and luck scales in addition to the other benefits of an immobile pretender. "
#fixedname "Corellon Larethian"
#gcost 10000
#miscshape
#startdom 4
...
-- 7494 -- Moonbow Shrine 4 
#newmonster 7494
#copystats 158
#clearspec
#clearmagic
#spr1 "ForgottenRealms/templesehaninemoonbow.tga"
#spr2 "ForgottenRealms/templesehaninemoonbow2.tga"
#name "Temple of the Moonbow"
#descr "Elven clerics worshipped many gods within their pantheon, known collectively as the Seldarine. Most Corellon Larethian, the creator of the Seldarine and the patron god of elvenkind, but Sehanine Moonbow, goddess of dreams and keeper of the dead, was also widely revered. While she did not often interfere in mortal matters, she did personally weave illusion magics that shrouded many elven retreats, such as the fabled Evermeet and the hidden Chondathan city of Rucien-Xan. Despite her aloof nature, she also sent frequent omens to keep her people from danger. 
...
-- 8048 -- Mystic Theurge - Pretender 1
#newmonster 8048
#copystats 6600
#spr1 "ForgottenRealms/mystictheurge.tga"
#spr2 "ForgottenRealms/mystictheurge2.tga"  
#name "Mystic Theurge"
#descr "Mystic theurges blur the line between divine and arcane, drawing power from both divine sources and ancient tomes alike. While most spellcasters chose one path to magical power, mystic theurges are able to simultaneously master spells common to clerics and wizards. Fascinated with magic in whatever form it takes, they were often obsessed with magical lore, traveling to the ends of the multiverse to learn some new arcane secret or divine insight.

Several mystic theurges desired the power of apotheosis itself, and sought to ascend to godhood." 
#gcost 10000
#nametype 113
#hp 16
#str 9
...
#clearweapons
#cleararmor
#spr1 "ForgottenRealms/demogorgon.tga"
#spr2 "ForgottenRealms/demogorgon2.tga"
#name "The Imprisoned One"
#fixedname "Demogorgon"
#descr "Demogorgon was the demon lord and lesser deity of domination and the draining of energy. He was the embodiment of madness and destruction and sought to drag all down into the infinite depths of the Abyss. He was known by many names: called the Imprisoned One by the followers of Helm, Siosivash by the yuan-ti, Leemooggoogoon the Deep Father by the kuo-toa, and Ahmon-Ibor the Sibilant Beast by the troglodytes.

The first tanar'ri, formed from mortals' ancient fears, even his chosen race, the ixitxachitl, dared not speak his name aloud. Inspiring fear in even other demon lords, his self-proclaimed title of Prince of Demons was won by virtue of power and influence - many demons challenged it, but none could defeat Demogorgon and claim it.

Demogorgon preferred to avoid direct conflict, instead using magic to help his servants. In combat, he could hypnotize with a gaze and drive creatures around him to terror and insanity just at the sight of him. His whip-like tail had the ability to drain the life of living foes, and his tentacles inflicted a withering disease that caused the living to rot away. He was also known to be extremely resistant to magic.

In addition to being worshipped by the Demon Rays known as ixitxachitls, he was also worshipped by troglodytes, kuo-toa, aboleths, merrows, scrags, and other demons. He offered pacts with Warlocks, and is credited with the creation of chimeras, ettins, and many other strange creatures of the abyss who burst their way into the material plane from time to time.

Demogorgon was a legendary enemy of Orcus and dedicated foe of Graz'zt. He equally hated Sekolah and his faithful sahuagin who briefly succeeded long ago in subjugating him with the power of an artifact that has long since been destroyed. Dagon and Zuggtmoy were the only known deities to occassionally cooperate with Demogorgon."  
#gcost 10000
#ambidextrous 2
#combatcaster
#chaospower 2
...
#goodleader
#inspirational 3
#makemonsters1 7636 -- Corrupt Large Water Elemental
#invulnerable 25
#startdom 2
#pathcost 30
#minprison 2 -- must be imprisoned
#moreorder -2
#itemslots 2056192 -- 2 heads, body, feet, 3 miscs
#weapon 595 -- hypnotize
#weapon 595 -- hypnotize
#weapon 636 -- Life Draining Tentacle
#weapon 636 -- Life Draining Tentacle
#weapon 1870 -- Demogorgon's Tail
#end

-- 8050 -- Temple of Sekolah
#newmonster 8050
#copystats 158
#clearspec
#spr1 "ForgottenRealms/templeofsekolah.tga"
#spr2 "ForgottenRealms/templeofsekolah2.tga"
#name "Temple of the Shark-Father"
#descr "Sekolah was the shark god of the Sahuagin. Legend had it that Sekolah discovered the sahuagin race after he had defeated a great enemy in the sea. Sekolah was singing a victory song that echoed off a great rift in the sea floor. A seashell arose from the rift and Sekolah found it full of sahuagin. In his joy, he adopted the race as his own and scattered them throughout the seas.

Rarely did his avatar visit Faerun, and only then to satiate himself on the great beasts of the open seas. He cared little for his priests, though he did grant them spells, and he was not opposed to his priests having temporary pacts with other evil deities. At least so long as they were not Demogorgon, with whom Sekolah had fierce rivalry and which carried over to his followers' hatred for the ray-like race of ixitxachitl.

Now and again, this temple will attract sacred Megalodons to your forces."
#clearmagic
#fixedname "Sekolah"
#gcost 10000
#miscshape
...
#moreluck -2
#goodundeadleader 
#domsummon20 8006 -- Megalodon
#end


-- 8051 -- TEMPLE OF DEEP SASHELAS
#newmonster 8051
#copystats 158
#clearspec
#spr1 "ForgottenRealms/templeofsashelas.tga"
#spr2 "ForgottenRealms/templeofsashelas2.tga"
#name "Lord of the Undersea"
#descr "Deep Sashelas (pr. SASH-ul-us) was an elven deity who made his home on Arvandor, although he was rumored to maintain a demesne off the coast of the Moonshae Isles. His presence was felt all across Toril and he sought to be on good terms with many of the underwater races beyond the sea elves. He rarely appeared as an avatar, doing so only to battle with Sekolah or Panzuriel. Vehemently opposed to the evil deities of the deep, he also worked diligently to thwart the forces of Demogorgon and Dagon. Trishina, the Goddess of Dolphins, was a close ally, as was Mystra and the many gods of the Seldarine pantheon. While he counted Eilistraee, the drow Goddess of the Dance, as a friend, he was a bitter enemy of both Vhaeraun and Lolth. 

In each Sea Elven settlement there was a temple dedicated to Deep Sashelas that typically looked like a giant shell. The Sea of Fallen stars had many such temples, and none more grand than Marultirthyr, the great temple of Myth Nantar. While the city's structures were allowed to grow thick with coral sheathes, the temple to Deep Sashelas was meticulously maintained.

In addition to encouraging excellent growth and order scales, the temple to the Lord of the Undersea attracts Dolphins, Orcas, and Whales as freespawn."
#clearmagic
#fixedname "Deep Sashelas"
#gcost 10050
#miscshape
#startdom 4
#size 9
...
#moregrowth 1
#moreluck 1
#domsummon20 7607 -- Sacred Dolphin
#domsummon20 8003 -- Orca
#domsummon20 8004 -- Whale
...
#copystats 1520 
#clearspec
#spr1 "ForgottenRealms/dagon.tga"
#spr2 "ForgottenRealms/dagon2.tga"
#name "Lord of the Darkened Depths"
#fixedname "Dagon"
#descr "Dagon (pr: Day-gon) was a primordial, an obyrith, and a demon lord. The Lord of the Darkened Depths laired in the Shadowsea, the 89th layer of the Abyss. Dagon was served by aquatic demons, especially wastriliths, and was worshiped by aquatic races such as kraken, chuuls, sea hags, water nagas, and kuo-toa.

In ancient myth, when the first primordials arrived in the Abyss, Dagon was already there, lurking in the depths. When Demogorgon went to claim the shard of evil, Dagon rose out of the Blood Sea to challenge him for control. Their rivalry has persisted in the eons since.

Dagon's history on Toril lay below the surface of the Sea of Fallen Stars. He and his minions lurked deep beneath the Trench of Lopok and were known by the tritons as 'Those who Sleep Below.' Dagon wished to achieve true divinity. To do so, he plotted to weaken and consume an entire pantheon of minor gods and chose the gods of the primitive Shalarin who lived in the Sea of Corynactis, near far-away Maztica. Dagon conjured ancient eldritch magic known as the 'Wild Tides' to sweep large numbers of shalarin from their homes and into the Sea of Fallen Stars, where his minions could slaughter them. The first wild tide began in −1509 DR with the opening of the Wildtider Gate near modern-day As'Arem. Many thousands of shalarin were suddenly swept into the Sea of Fallen Stars and roughly 70% were massacred in the confusion. Merfolk and tritons managed to rescue a small number, who found themselves cut off from their gods entirely. 

Dagon repeated this tactic every 720 years until the last wild tide of 1371 DR when the gate remained permanently open. The shalarin who poured into the Sea of Fallen Stars were horrificly found to have abandoned their native gods and now venerated Dagon himself. Unable to sever the connection and too fearful of revealing their shame, the Cult of Dagon took root among the shalarin and The Lord of the Darkened Depths edged closer to divinity."
#gcost 10000
#hp 325
#size 10
#prot 24
...
-- 8053 -- Primordial Father -- Dagon Pretender
#newmonster 8053
#copystats 1520 
#clearspec
#clearmagic
